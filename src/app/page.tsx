...
import { GoldButton, MiniStats } from "@/components/apex/ApexComponents";
  ...
  return (
    <div className="bg-gray-50 flex flex-col min-h-screen">
      ...
      <section className="relative bg-brand-midnight text-white pt-10 pb-20 px-6 overflow-hidden">
        ...
        <Plane className="absolute right-10 top-10 text-brand-gold opacity-50" size={32} />
        ...
        <div className="relative mx-auto max-w-7xl grid lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <Link href="/consultation" className="inline-flex h-12 items-center justify-center gap-2 rounded-xl border-2 border-white/20 px-6 text-sm font-bold text-white hover:bg-white/10 transition-colors">
                Book a Consultation
              </Link>
            </div>
          </div>
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6">
            {planningOptions.map((opt, i) => (
              <Link key={i} href={opt.href} className="flex flex-col items-center justify-center text-center p-6 bg-gray-50 hover:bg-gray-100 border border-gray-200 rounded-2xl transition-colors">
      ...
      <section className="py-16 px-6 bg-gray-50 flex-1">
        <div className="mx-auto max-w-7xl grid md:grid-cols-2 gap-6">
          <Link href="/about" className="bg-brand-midnight text-white p-8 md:p-10 rounded-3xl flex flex-col justify-between hover:ring-4 hover:ring-brand-midnight/20 transition-all">
            <div>
          ...
          <div className="bg-brand-ocean text-white p-8 md:p-10 rounded-3xl relative overflow-hidden flex flex-col justify-between">
